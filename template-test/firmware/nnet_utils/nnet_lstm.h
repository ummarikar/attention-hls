...
// output
	...
	relu   <typename CONFIG_T::accum_t, data_T, CONFIG_A> ( c_cur, c_cur_activ);  // tanh
	HIDDEN_UNITS:
...
void lstm_06_025(
    ...
    TIMESTEP:for(int its = 0; its < CONFIG_T::timestep; its++) {
        ...
        lstm_tail_02<data_T, CONFIG_T, CONFIG_A> (gate_i_activ, gate_f_activ, gate_g_activ, gate_o_activ, c_pre, c_cur, h_cur);
