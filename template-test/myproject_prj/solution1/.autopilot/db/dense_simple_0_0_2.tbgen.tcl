set moduleName dense_simple_0_0_2
set isTopModule 0
...
set C_modelName {dense_simple.0.0.2}
set C_modelType { int 16 }
set C_modelArgList {
	{ data_V int 16 regular {array 16 { 1 1 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	data_V { ap_memory {  { data_V_address0 mem_address 1 4 }  { data_V_ce0 mem_ce 1 1 }  { data_V_q0 mem_dout 0 16 }  { data_V_address1 MemPortADDR2 1 4 }  { data_V_ce1 MemPortCE2 1 1 }  { data_V_q1 MemPortDOUT2 0 16 } } }
}
set moduleName dense_simple_0_0_2
set isTopModule 0
set isTaskLevelControl 1
...
set C_modelArgList {
	{ data float 32 regular {array 16 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_fadd_32bkb_U7846", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_fadd_32bkb_U7847", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_fmul_32cud_U7848", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_fmul_32cud_U7849", "Parent" : "0"}]}
