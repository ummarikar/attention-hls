...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_exp_table10_rom (
...
initial begin
    $readmemh("./softmax_exp_table10_rom.dat", ram0);
    $readmemh("./softmax_exp_table10_rom.dat", ram1);
    $readmemh("./softmax_exp_table10_rom.dat", ram2);
    $readmemh("./softmax_exp_table10_rom.dat", ram3);
    $readmemh("./softmax_exp_table10_rom.dat", ram4);
    $readmemh("./softmax_exp_table10_rom.dat", ram5);
    $readmemh("./softmax_exp_table10_rom.dat", ram6);
    $readmemh("./softmax_exp_table10_rom.dat", ram7);
    $readmemh("./softmax_exp_table10_rom.dat", ram8);
    $readmemh("./softmax_exp_table10_rom.dat", ram9);
    $readmemh("./softmax_exp_table10_rom.dat", ram10);
    $readmemh("./softmax_exp_table10_rom.dat", ram11);
    $readmemh("./softmax_exp_table10_rom.dat", ram12);
    $readmemh("./softmax_exp_table10_rom.dat", ram13);
    $readmemh("./softmax_exp_table10_rom.dat", ram14);
    $readmemh("./softmax_exp_table10_rom.dat", ram15);
    $readmemh("./softmax_exp_table10_rom.dat", ram16);
    $readmemh("./softmax_exp_table10_rom.dat", ram17);
    $readmemh("./softmax_exp_table10_rom.dat", ram18);
    $readmemh("./softmax_exp_table10_rom.dat", ram19);
    $readmemh("./softmax_exp_table10_rom.dat", ram20);
    $readmemh("./softmax_exp_table10_rom.dat", ram21);
    $readmemh("./softmax_exp_table10_rom.dat", ram22);
    $readmemh("./softmax_exp_table10_rom.dat", ram23);
    $readmemh("./softmax_exp_table10_rom.dat", ram24);
    $readmemh("./softmax_exp_table10_rom.dat", ram25);
    $readmemh("./softmax_exp_table10_rom.dat", ram26);
    $readmemh("./softmax_exp_table10_rom.dat", ram27);
end
...
softmax_exp_table10_rom softmax_exp_table10_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
