...
module AESL_automem_input_1_12_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.myproject.autotvin_input_1_12_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.myproject.autotvout_input_1_12_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 16;
parameter ADDR_WIDTH = 32'd 5;
parameter DEPTH = 32'd 28;
parameter DLY = 0.1;
