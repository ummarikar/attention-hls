...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module sigmoid_1_sigmoidbkb_rom (
...
initial begin
    $readmemh("./sigmoid_1_sigmoidbkb_rom.dat", ram0);
    $readmemh("./sigmoid_1_sigmoidbkb_rom.dat", ram1);
    $readmemh("./sigmoid_1_sigmoidbkb_rom.dat", ram2);
    $readmemh("./sigmoid_1_sigmoidbkb_rom.dat", ram3);
end
...
sigmoid_1_sigmoidbkb_rom sigmoid_1_sigmoidbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
