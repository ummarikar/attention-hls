...
// ==============================================================
#ifndef __myproject_mul_mulibs__HH__
#define __myproject_mul_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_mulibs) {
    ...
    SC_CTOR(myproject_mul_mulibs):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
