...
// ==============================================================
#ifndef __sigmoid_1_sigmoidbkb_H__
#define __sigmoid_1_sigmoidbkb_H__
...
struct sigmoid_1_sigmoidbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_1_sigmoidbkb_ram) {
...
SC_MODULE(sigmoid_1_sigmoidbkb) {
...
sigmoid_1_sigmoidbkb_ram* meminst;


SC_CTOR(sigmoid_1_sigmoidbkb) {
meminst = new sigmoid_1_sigmoidbkb_ram("sigmoid_1_sigmoidbkb_ram");
