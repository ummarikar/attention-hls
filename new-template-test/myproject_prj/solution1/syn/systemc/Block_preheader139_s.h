...
#ifndef _Block_preheader139_s_HH_
#define _Block_preheader139_s_HH_
...
struct Block_preheader139_s : public sc_module {
    ...
    // Module declarations
    Block_preheader139_s(sc_module_name name);
    SC_HAS_PROCESS(Block_preheader139_s);
