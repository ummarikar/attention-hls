...
initial begin
    ...
    $readmemh("./softmax_exp_table2_rom.dat", ram15);
    $readmemh("./softmax_exp_table2_rom.dat", ram16);
    $readmemh("./softmax_exp_table2_rom.dat", ram17);
    $readmemh("./softmax_exp_table2_rom.dat", ram18);
    $readmemh("./softmax_exp_table2_rom.dat", ram19);
    $readmemh("./softmax_exp_table2_rom.dat", ram20);
    $readmemh("./softmax_exp_table2_rom.dat", ram21);
    $readmemh("./softmax_exp_table2_rom.dat", ram22);
    $readmemh("./softmax_exp_table2_rom.dat", ram23);
    $readmemh("./softmax_exp_table2_rom.dat", ram24);
    $readmemh("./softmax_exp_table2_rom.dat", ram25);
    $readmemh("./softmax_exp_table2_rom.dat", ram26);
    $readmemh("./softmax_exp_table2_rom.dat", ram27);
    $readmemh("./softmax_exp_table2_rom.dat", ram28);
    $readmemh("./softmax_exp_table2_rom.dat", ram29);
    $readmemh("./softmax_exp_table2_rom.dat", ram30);
    $readmemh("./softmax_exp_table2_rom.dat", ram31);
    $readmemh("./softmax_exp_table2_rom.dat", ram32);
    $readmemh("./softmax_exp_table2_rom.dat", ram33);
    $readmemh("./softmax_exp_table2_rom.dat", ram34);
    $readmemh("./softmax_exp_table2_rom.dat", ram35);
    $readmemh("./softmax_exp_table2_rom.dat", ram36);
    $readmemh("./softmax_exp_table2_rom.dat", ram37);
    $readmemh("./softmax_exp_table2_rom.dat", ram38);
    $readmemh("./softmax_exp_table2_rom.dat", ram39);
    $readmemh("./softmax_exp_table2_rom.dat", ram40);
    $readmemh("./softmax_exp_table2_rom.dat", ram41);
    $readmemh("./softmax_exp_table2_rom.dat", ram42);
    $readmemh("./softmax_exp_table2_rom.dat", ram43);
    $readmemh("./softmax_exp_table2_rom.dat", ram44);
end
